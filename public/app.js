...
async function loadStats(){
  try{
    ...
    const data=await r.json();
    document.getElementById("siteAccesses").textContent=(data.site_accesses||0).toLocaleString("pt-BR");
    document.getElementById("locationShares").textContent=(data.location_shares||0).toLocaleString("pt-BR");
    document.getElementById("locationQueries").textContent=(data.location_queries||0).toLocaleString("pt-BR");
  }catch(e){}
}
loadStats();
